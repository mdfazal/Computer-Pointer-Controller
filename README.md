...
## Demo video
[![Demo video](https://img.youtube.com/vi/qR9rQQ4wiMQ/0.jpg)](https://youtu.be/wmWSx5jR1N8)
...
1. If multiple people are in the frame then the application selects one person to work with. This solution works in most cases but may introduce flickering effect between two heads.

2. If there is more than one face detected, it extracts only one face and do inference on it and ignoring other faces.
